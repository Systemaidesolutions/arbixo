...
// the pure 2550Q helpers now live in lib/vat2550q (which has no prisma import),
// so client components can use them without pulling server-only code into the
// browser bundle (that was breaking `next build`).
export type { VatReturn } from "@/lib/vat2550q";
