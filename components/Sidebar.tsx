          ...
          return (
            <div key={section.title} className="px-2">
              <button
                ...
                className={`flex w-full items-center gap-2 rounded px-2 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50 ${
                  collapsed ? "justify-center" : "justify-between"
                }`}
                title={section.title}
              >
                <span className="flex items-center gap-2">
                  <Icon size={16} className="shrink-0 text-brand-navy" />
